...
int main()
{
	...
	while (t--)
	{
		...
		vector<vector<ll>> rightDiffArr(N + 2, vector<ll>(M + 2, 0)); // For type 1 (right diagonal - main diagonal)
		vector<vector<ll>> leftDiffArr(N + 2, vector<ll>(M + 2, 0));  // For type 2 (left diagonal - anti diagonal)
